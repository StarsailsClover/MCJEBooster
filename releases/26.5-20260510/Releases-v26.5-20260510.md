# MCJEBooster v26.5-20260510 Release Notes

**Release Version:** v26.5-20260510  
**Release Date:** 2026-05-10  
**Injector Version:** 26.5-20260510
...
**Note:** This release requires injector version 26.5-20260510 or higher. Older injectors may not support all adapter features.
...
2. Download and run the injector:
   ```bash
   java -jar MCJEBooster-26.5-20260510.jar
   ```
...
```bash
-javaagent:/path/to/MCJEBooster-26.5-20260510.jar
```
...
```
{{SHA256_CHECKSUMS_WILL_BE_GENERATED_DURING_BUILD}}
```
...
*Release v26.5-20260510 - 2026-05-10*
